    ...
    <div className="space-y-4 p-4 border rounded-lg bg-yellow-50">
      ...
      <div>
        ...
        <Input
          ...
          {...register("quizPassingScore", {
            required:
              selectedType === "QUIZ"
                ? "Nota mínima é obrigatória para quizzes"
                : false,
      ...
      <div className="bg-blue-50 border border-blue-200 p-3 rounded">
        ...
        <ol className="text-sm text-blue-800 space-y-1">
          ...
          <li>
            2. Use o formato: pergunta, opções (a, b, c, d) e resposta correta
          </li>
          <li>3. Exemplo: "Qual é 2+2? a) 3 b) 4 c) 5 d) 6 - Resposta: b"</li>
          <li>
            4. Para múltiplas perguntas, separe cada uma com uma linha em branco
          </li>
        </ol>
      </div>
    </div>
